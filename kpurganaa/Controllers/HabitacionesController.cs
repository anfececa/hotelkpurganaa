...
namespace kpurganaa.Controllers
{
    public class HabitacionesController : Controller
    {
        ...
        public HabitacionesController(kapurganaaContext context)
        {
            _context = context;
        }
        ...
        {
            var kapurganaaContext = _context.Habitaciones.Include(h => h.IdTipoHabitacionNavigation);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'kapurganaaContext.Habitaciones'  is null.");
            }
            var habitacione = await _context.Habitaciones.FindAsync(id);
            if (habitacione != null)
            {
