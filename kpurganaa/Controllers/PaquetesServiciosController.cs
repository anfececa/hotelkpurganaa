...
namespace kpurganaa.Controllers
{
    ...
    public class PaquetesServiciosController : Controller
    {
        ...
        public PaquetesServiciosController(kapurganaaContext context)
        {
            _context = context;
        }
        ...
        {
            var kapurganaaContext = _context.PaquetesServicios.Include(p => p.IdPaqueteNavigation).Include(p => p.IdServicioNavigation);
        ...
        {
            if (id == null || _context.PaquetesServicios == null)
            {
                return NotFound();
            }
        ...
        {
            if (_context.PaquetesServicios == null)
            {
                return Problem("Entity set 'kapurganaaContext.PaquetesServicios'  is null.");
            }
            var paquetesServicio = await _context.PaquetesServicios.FindAsync(id);
            if (paquetesServicio != null)
            {
        ...
        {
          return (_context.PaquetesServicios?.Any(e => e.IdPaquetesServicios == id)).GetValueOrDefault();
        }
    }
}
